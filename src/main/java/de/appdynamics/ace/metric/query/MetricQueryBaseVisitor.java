...
/**
 * This class provides an empty implementation of {@link MetricQueryVisitor},
 ...
 */
public class MetricQueryBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements MetricQueryVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
